...
// Signs raw byte messages. Messages are hashed internally by zero-based position.
int32_t bbs_sign(
    BbsByteSlice params,
...
// Verifies a signature over raw byte messages using the same internal hashing as bbs_sign.
...
// Creates a selective-disclosure proof. revealed_indices are zero-based message indexes.
